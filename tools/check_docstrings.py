...
def check_function(
    ...
    **Return:**
    ...
    return [
        *_check_arguments(node, path, qualifiedName, docstring),
        *_check_return(node, path, qualifiedName, docstring),
    ]
...
def _check_arguments(
    ...
    """*compare a function's arguments with its documented arguments*"""
    findings = []
...
def _check_return(
    ...
    """*compare a function's return behaviour with its documented return*"""
    findings = []
