...
class test_subtract_sky(unittest.TestCase):
    ...
    def test_xsh_2D_image_to_DF_function(self):
        ...
        mapDF, interOrderMask = twoD_disp_map_image_to_dataframe(
            log=log, twoDMapPath=twoDMap, associatedFrame=objectFrame, slit_length=11, kw=kw
        )
    ...
    def test_soxs_subtract_sky_function_exception(self):
        ...
        try:
            this = subtract_sky(log=log, settings=settings, fakeKey="break the code")
            this.get()
            assert False
