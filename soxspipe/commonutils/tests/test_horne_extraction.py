...
class test_horne_extraction(unittest.TestCase):
    ...
    def test_horne_extraction_merge_function(self):
        ...
        extractedOrdersTable = "~/xshooter-pipeline-data/unittest_data/xsh/xshooter-horne-extraction/nir/2019.08.22T23.12.18.5011_NIR_STARE_205PT0_EG_274_EXTRACTED_ORDERS.fits"
