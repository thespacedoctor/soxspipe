    ...
    **Key Arguments**
    ...
    def produce_product(
        ...
        **Usage**
        ...
        quicklook_image(
            log=self.log, CCDObject=combined_object, show=True, ext=False, stdWindow=3, title=False, surfacePlot=False, dispMap=dispMap, dispMapImage=twoDMap, settings=self.settings, skylines=False)
