...
class test_soxs_stare_mode(unittest.TestCase):

    # def test_soxs_stare_mode_nir_function(self):
    ...
    # def test_soxs_stare_mode_uvb_function(self):
    ...
    # def test_soxs_stare_mode_vis_function(self):
    ...
    # def test_soxs_stare_mode_function(self):
    ...
    # def test_soxs_stare_mode_function_exception(self):
