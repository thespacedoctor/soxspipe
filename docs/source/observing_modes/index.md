...
The driving motivation for observing with noddingor offset mode over stare mode is to isolate the target flux more accurately by providing a cleaner sky background subtraction. 
