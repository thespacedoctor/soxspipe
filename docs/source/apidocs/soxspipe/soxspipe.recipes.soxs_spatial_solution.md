...
`````{py:class} soxs_spatial_solution(log, settings=False, inputFrames=[], verbose=False, overwrite=False, create2DMap=True, polyOrders=False, command=False, debug=False, turnOffMP=False)
...
:canonical: soxspipe.recipes.soxs_spatial_solution.soxs_spatial_solution.flag_poor_data
