...
`````{py:class} soxs_straighten(log, settings=False, inputFrames=[], verbose=False, overwrite=False, command=False, debug=False, turnOffMP=False)
...
:canonical: soxspipe.recipes.soxs_straighten.soxs_straighten.flag_poor_data
