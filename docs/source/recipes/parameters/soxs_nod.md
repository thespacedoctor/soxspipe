...
| horne-extraction-profile-poly-order | degree of the polynomial used to fit the dispersion-direction profiles of the object. | int | settings file | [`horne_extraction`]( |
